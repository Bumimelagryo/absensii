        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="index.php" class="logo">Absensi Karyawan</a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-md-12 col-sm-12">
                    <p class="copyright">Copyright &copy; <script>document.write(new Date().getFullYear());</script> Bumi 
                ...
                <div class="col-lg-5 col-md-12 col-sm-12">
                    <ul class="social">
                        ...
                        <li><a href="#"  target="_blank" ><i class="fa fa-github"  target="_blank"></i></a></li>
                        <li><a href="#" target="_blank"><i class="fa fa-linkedin" target="_blank"></i></a></li>
